...
const db = {
  ...
  pedidos: [
    ...
    { id: 7, num: 'PV24/00107', cliente: 'Materiales Aragón', destino: 'Zaragoza (50016)', ubicacion: 'Pasillo B', estado_prep: 'sin_preparar', fecha: addDays(4), kg: 13500, porte: 0, prio: 'normal', paradas: 1, obs: '', carga_id: null, orden_carga: null, categoria_id: null, maps_url: '', direccion_descarga: '', preparador: '', obs_prep: '', es_agencia: false, recogen: true, medidas: '', cambios: '', tiene_cambios: false, comercial: '', entregado_at: null },
  ],
  pedido_lineas: {
    1: [
  ...
  producciones: [
    ...
    { id: 30, tipo: 'saco', mp_id: 2, unidades: 100, kg_unidad: 25, kg_total: 2500, silo_id: 2, estado: 'hecho', notas: '', fecha: addDays(-1), hecho_at: addDays(-1), origen_linea_id: null, material: 'Cemento gris', silo_nombre: 'Tolva 1', cliente: null, fabricante: null, orden: 0, servido: false },
    { id: 31, tipo: 'bb', mp_id: 1, unidades: 6, kg_unidad: 1000, kg_total: 6000, silo_id: 1, estado: 'hecho', notas: '', fecha: addDays(-1), hecho_at: addDays(-1), origen_linea_id: null, material: 'Arena silícea', silo_nombre: 'Tolva 0', cliente: null, fabricante: null, orden: 0, servido: false },
  ],
  viajes: [
    ...
    { id: 3, mp_id: 5, kg: 24000, silo_id: null, fecha: addDays(0), estado: 'pendiente', destino_tipo: null, destino_silo_id: null, kg_final: null, acopio: null, origen: 'produccion', notas: '', hora: '', material: 'Arena blanca 0-4', silo_nombre: null, destino_silo_nombre: null },
  ],
  compras: [
